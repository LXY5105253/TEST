...
import com.hbjy.lxy.rxview.debug.DebugFragmentRecord;
import com.hbjy.lxy.rxview.debug.DebugHierarchyViewContainer;
...
public class Fragmentation {
     ...
     * save requestCode
     */
    private void saveRequestCode(SupportFragment to, int requestCode) {
        Bundle bundle = to.getArguments();
        if (bundle == null) {
            bundle = new Bundle();
